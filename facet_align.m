%%%%%%%%%%%%%%%%
%This function is a PID-controller that takes the position of the beam 
%in each camera in the laser transport system and calculates the appropiate corrective response
%using the response matrix, a matrix that describes the mapping 
% ==========
